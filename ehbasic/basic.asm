    ...
    Code_base = __APP_START__     ; *** RAM above code Patch ***
    ...
    Ram_top		= __APP_START__	; end of user RAM+1 (set as needed, should be page aligned)
...
;	.word	V_INPT			; non halting key input	-	monitor to set this
;	.word	V_OUTP			; output vector		-	monitor to set this
;	.word	V_LOAD			; load vector		-	monitor to set this
;	.word	V_SAVE			; save vector		-	monitor to set this
PG2_TABE:
...
LAB_2CEE:
	INC	Bpntrl		; increment BASIC execute pointer low byte      ;bc
	BNE	LAB_2CF4	; branch if no carry                            ;be
					; else
	INC	Bpntrh		; increment BASIC execute pointer high byte     ;c0

; page 0 initialisation table from $C2
; scan memory
LAB_2CF4:
	LDA	$FFFF			; get byte to scan (addr set by call routine) ;c2
